...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, /* */ KC_NO, KC_PERC, KC_HASH, KC_LBRC, KC_RBRC, KC_BSLS, KC_PIPE,
    KC_TRNS, L_XX, L_XX, KC_TRNS, /* */ KC_TRNS, KC_TRNS, L_XX, KC_TRNS),
	[3] = LAYOUT(
    KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,  /* */ KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, TG(_GAM),
    ...
    DF(1), L_XX, L_XX, KC_TRNS, /* */ KC_TRNS, KC_TRNS, L_XX, DF(0)),
	[4] = LAYOUT(
