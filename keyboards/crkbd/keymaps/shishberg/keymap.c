...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    L_SYM, L_NUM, KC_SPC, /* */ KC_ENT, KC_BSPC, L_NUM),
    ...
    KC_TRNS, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, /* */ KC_CIRC, KC_AMPR, KC_LCBR, KC_RCBR, KC_EXLM, KC_TILD,
    KC_TRNS, KC_F5, KC_F6, KC_F7, KC_F8, KC_PAUS, /* */ KC_DLR, KC_ASTR, KC_LPRN, KC_RPRN, KC_AT, KC_GRV,
    KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, RGB_MOD, /* */ KC_PERC, KC_HASH, KC_LBRC, KC_RBRC, KC_BSLS, KC_PIPE,
    L_XX, L_XX, KC_TRNS, /* */ KC_TRNS, KC_TRNS, L_XX),
	[3] = LAYOUT_split_3x6_3(
    KC_TRNS, KC_VOLU, KC_HOME, KC_UP, KC_END, KC_PGUP, /* */ KC_NO, KC_7, KC_8, KC_9, KC_NO, DF(0),
    KC_TRNS, KC_VOLD, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, /* */ KC_NO, KC_4, KC_5, KC_6, KC_0, DF(1),
    KC_TRNS, KC_MUTE, KC_MSTP, KC_MPRV, KC_MNXT, KC_MPLY, /* */ KC_NO, KC_1, KC_2, KC_3, KC_DOT, KC_NO,
    L_XX, L_XX, KC_TRNS, /* */ KC_TRNS, KC_TRNS, L_XX)
};
